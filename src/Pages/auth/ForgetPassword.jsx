...
import { ForgotPassAuth } from "../../Redux/authSlice/authSlice";
...
const ForgetPassword = () => {
  ...
  const handleSubmit = () => {
    ...
    if (val) {
      ...
      dispatch(ForgotPassAuth(UserName, handleErr, handleSuccess));
    }
  };
      ...
      {isLoading ? (
        ...
        <CardWithTwoSection>
          <div className="registration_leftside">
            <img src={"Images/forgetpass1.jpg"} alt="forgot password image" />
          </div>
